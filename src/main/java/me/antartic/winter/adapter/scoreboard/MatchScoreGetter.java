...
import me.antartic.winter.util.PlayerUtils;
import me.antartic.winter.util.TimeUtils;
import me.antartic.winter.pvpclasses.pvpclasses.ArcherClass;
import me.antartic.winter.pvpclasses.pvpclasses.BardClass;
import me.antartic.winter.util.scoreboard.construct.ScoreFunction;
...
import me.antartic.winter.kit.kittype.HealingMethod;
...
/**
 * Implements the scoreboard as defined in {@link me.antartic.winter.util.scoreboard}<br />
...
final class MatchScoreGetter implements BiConsumer<Player, List<String>> {
    ...
    private void renderBoxingLines(List<String> scores, MatchTeam ourTeam, MatchTeam otherTeam) {
        Match match = PotPvPRP.getInstance().getMatchHandler().getMatchPlaying(Bukkit.getPlayer((UUID)ourTeam.getFirstMember()));
