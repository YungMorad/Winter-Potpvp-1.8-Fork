package me.antartic.winter.kit.kittype;
...
public final class KitType {
    ...
    @Getter @Setter private String knockbackProfile = "default";

    @Getter @Setter private int damageticks = 20;
    ...
    @Getter @Setter private boolean boxing = false;

    @Getter @Setter private boolean falldamage = false;
