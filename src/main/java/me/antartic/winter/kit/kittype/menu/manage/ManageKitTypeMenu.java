...
import me.antartic.winter.util.menu.BooleanTraitButton;
import me.antartic.winter.util.menu.Button;
import me.antartic.winter.util.menu.IntegerTraitButton;
...
public class ManageKitTypeMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        // Vertical row
        buttons.put(getSlot(0, 0), new KitInfosButton(type));
        ...
        buttons.put(getSlot(0, 2), new BooleanTraitButton<>(type, "Sumo", KitType::setSumo, KitType::isSumo, KitType::saveAsync));
        buttons.put(getSlot(8, 3), new IntegerTraitButton<>(type, "Damage Ticks", KitType::setDamageticks, KitType::getDamageticks, KitType::saveAsync));
