...
import me.antartic.winter.match.listener.*;
...
public final class MatchHandler {
    ...
    public MatchHandler() {
        ...
        Bukkit.getPluginManager().registerEvents(new MatchFallDamageListener(), PotPvPRP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchHardcoreHealingListener(), PotPvPRP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchKnockbackListener(), PotPvPRP.getInstance());
