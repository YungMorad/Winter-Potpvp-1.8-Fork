...
import net.frozenorb.potpvp.arena.cache.ArenaCache;
import net.frozenorb.potpvp.arena.cache.ArenaChunk;
import net.frozenorb.potpvp.util.Callback;
import net.frozenorb.potpvp.util.Cuboid;
import net.frozenorb.potpvp.util.chunk.ChunkUtil;
    ...
    private void forEachChunk(Callback<Chunk> callback) {
        ...
        for (int x = lowerX; x <= upperX; x++) {
            for (int z = lowerZ; z <= upperZ; z++) {
                callback.callback((Chunk) world.getChunkAt(x, z));
            }
        }
    }
