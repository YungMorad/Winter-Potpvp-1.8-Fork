...
public final class MatchTeam {
    ...
    public void broadcastTitle(String title, String subtitle) {
        this.getAllMembers().forEach(player -> Bukkit.getPlayer(player).sendTitle(new Title(title, subtitle)));
    }

    public void broadcastTitle(String title, String subtitle, int fadeIn, int stay, int fadeOut) {
        this.getAllMembers().forEach(player -> Bukkit.getPlayer(player).sendTitle(new Title(title, subtitle, fadeIn, stay, fadeOut)));
    }
